    ...
    private void LateUpdate()
    {
        ...
        if (alignToLookPoint && aimAlignmentStrength > 0f)
        {
            ...
            if (aimDirection.sqrMagnitude > 0.0001f)
            {
                ...
                Quaternion correction = Quaternion.FromToRotation(currentForward, aimDirection.normalized);
